/* Generated by re2c 0.13.5 on Thu Jun 30 18:22:17 2016 */
...
yy14:
	++YYCURSOR;
#line 850 "ext/standard/var_unserializer.re"
	{
...
#line 813 "ext/standard/var_unserializer.c"
yy32:
	yych = *++YYCURSOR;
	if (yych == '+') goto yy33;
	if (yych <= '/') goto yy18;
...
#line 911 "ext/standard/var_unserializer.c"
yy46:
	yych = *++YYCURSOR;
	if (yych == '+') goto yy47;
	if (yych <= '/') goto yy18;
...
#line 965 "ext/standard/var_unserializer.c"
yy53:
	yych = *++YYCURSOR;
	if (yych <= '/') {
		if (yych <= ',') {
